...
class ViewHomeWorkTemplate : DatePickerDialog.OnDateSetListener {
    ...
    private fun editStudentMode(holder: ViewGroup?, hw: HomeWork?) {
        ...
        sura1.adapter = ArrayAdapter(studentActivity,
        ...
        ayah1.adapter = ArrayAdapter(studentActivity,
                R.layout.spinner_custom_item,
                ayat)
        ayah1.setSelection(hw.getAyah1() - 1)
        sura2 = hwTemplate.findViewById(R.id.sura_end_spinner)
        sura2.adapter = ArrayAdapter(studentActivity,
                R.layout.spinner_custom_item,
                sowarNames)
        ...
        ayah2.adapter = ArrayAdapter(studentActivity,
                R.layout.spinner_custom_item,
                ayat2)
        ayah2.setSelection(hw.getAyah1() - 1)

        //Listeners
        sura1.onItemSelectedListener = object : OnItemSelectedListener {
        ...
        sura2.onItemSelectedListener = object : OnItemSelectedListener {
            override fun onItemSelected(adapterView: AdapterView<*>?, view: View?, i: Int, l: Long) {
        ...
        delHW.setOnClickListener { view: View? ->
            AlertDialog.Builder(studentActivity
                    ...
                    .setPositiveButton(R.string.yes) { dialogInterface: DialogInterface?, i: Int ->
                        ...
                        studentActivity.hws.remove(this@ViewHomeWorkTemplate)
        ...
        clearDate.setOnClickListener { view: View? ->
            ...
            deadline_date_view.setText(studentActivity
                    .resources.getText(R.string.date_not_set))
        }
    }
    ...
    fun viewHomeworkMode(holder: ViewGroup?, hw: HomeWork?) {
        ...
        saveRating.setOnClickListener { view: View? ->
            ...
            } else if (view.getTag() as Int == R.drawable.edit_24) {
    ...
    fun init_date_picker() {
        ...
        //finding views//
        add_deadline.setOnClickListener(View.OnClickListener { view: View? -> dpd.show(studentActivity.supportFragmentManager, "Datepickerdialog") })
    }
    ...
    init {
        sowar_verses_num = studentActivity
                .resources.getIntArray(R.array.sowar_verses_num)
        sowarNames = studentActivity
                .resources.getStringArray(R.array.sura_names)
        config = studentActivity.applicationContext.resources.configuration

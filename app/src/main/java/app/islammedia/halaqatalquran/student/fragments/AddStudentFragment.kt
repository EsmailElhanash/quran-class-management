...
class AddStudentFragment : Fragment() , View.OnClickListener{
    ...
    private fun addStudentMode() {
        ...
        addHomeWorkButton.setOnClickListener(View.OnClickListener { view: View? -> addedHomeWorks.add(StudentHomeworkViewTemplate(this, hwsHolder, 1, null)) }
        )
        ...
        saveB.setOnClickListener { v: View? ->
            if ((stName.getText().toString() == "")) {
                ...
                for (hw: StudentHomeworkViewTemplate? in addedHomeWorks) if ((hw.hw_title.text.toString() == "")) {
